					...
					<div id="modifyForm">
						<form action="/MySite/board" method="get">
							...
							<div class="form-group">
								...
								<span class="form-value">${requestScope.bvo.regDate }</span>
							</div>
							
							<!-- 제목 -->
							<div class="form-group">
								<label class="form-text" for="txt-title">제목</label>
								<input type="text" id="txt-title" name="title" value="${requestScope.bvo.title }">
							</div>
							...
							<a id="btn_cancel" href="/MySite/board?action=read&no=${requestScope.bvo.no }">취소</a>
